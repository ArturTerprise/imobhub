...
import cub from "@/assets/integrations/cub.png";
...
const integrationCategories = [
  {
    ...
    icon: Building2,
    integrations: [
      { name: "Canal Pro", logo: canalpro, comingSoon: false },
      { name: "Chaves na Mão", logo: chavesnamao, comingSoon: false },
      { name: "62 Imóveis", logo: imoveis62, comingSoon: false },
      { name: "Imóvel Web", logo: imovelweb, comingSoon: false },
    ],
  },
  {
    ...
    icon: MessageSquare,
    integrations: [
      { name: "WhatsApp", logo: whatsapp, comingSoon: false },
      { name: "Meta", logo: meta, comingSoon: false },
      { name: "Canal Pro", logo: canalpro, comingSoon: false },
      { name: "Chaves na Mão", logo: chavesnamao, comingSoon: false },
      { name: "62 Imóveis", logo: imoveis62, comingSoon: false },
      { name: "Imóvel Web", logo: imovelweb, comingSoon: false },
  ...
  },
  {
    ...
    icon: FileSignature,
    integrations: [
      { name: "Autentique", logo: autentique, comingSoon: false },
      { name: "DocuSign", logo: docusign, comingSoon: false },
      { name: "D4Sign", logo: d4sign, comingSoon: false },
    ],
  },
  {
                  ...
                  {category.integrations.map((integration, index) => (
                    ...
                    >
                      {integration.comingSoon && (
                        <span className="absolute -top-2 -right-2 z-10 px-2 py-0.5 text-xs font-semibold rounded-full bg-accent text-white shadow-sm">
                          Em breve
                        </span>
                      )}
