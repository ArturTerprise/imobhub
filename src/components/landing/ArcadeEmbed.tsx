...
export function ArcadeEmbed() {
  ...
  return (
    <div style={{ position: 'relative', paddingBottom: 'calc(50.10416666666667% + 41px)', height: '0', width: '100%' }}>
      <iframe
        ref={arcadeIframeRef}
        src="https://demo.arcade.software/iCTzPF79P10kG7WsL9sy?embed&embed_mobile=modal&embed_desktop=modal&show_copy_link=true"
        title="Gerenciar propostas, vendas e certificados imobiliários no painel CRM"
        frameBorder="0"
        loading="lazy"
        allowFullScreen
